    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Chatbot Editor</h2>
          <p className="text-gray-600 max-w-md mx-auto">
            The chatbot editor is coming soon. You'll be able to design and customize your chatbot flows here.
          </p>
        </div>
      </div>
    </div>
