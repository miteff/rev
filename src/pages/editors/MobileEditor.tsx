...
import { ArrowLeft, Code, Eye, Smartphone } from 'lucide-react';
import { Preview } from '../../components/editor/Preview';
import { useWebsite } from '../../hooks/useWebsite';
import { useMobileBlockVariants } from '../../hooks/useMobileBlockVariants';
...
export function MobileEditor() {
  ...
  const { variants, loading } = useMobileBlockVariants();
              ...
              <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg mr-4">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
                    screenSize === 'small' ? 'bg-white shadow text-gray-900' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
                    screenSize === 'medium' ? 'bg-white shadow text-gray-900' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                  <Smartphone className="w-4 h-4" />
                  Medium
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
                    screenSize === 'large' ? 'bg-white shadow text-gray-900' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                  <Smartphone className="w-4 h-4" />
                  Large
